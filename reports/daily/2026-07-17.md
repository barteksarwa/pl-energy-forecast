...
| Forecast | MAPE |
|---|---|
| Ours (naive, incumbent) | 4.32% |
| Challenger (ridge+TSO, shadow) | 1.72% |
| TSO day-ahead | 1.88% |
...
3. Warsaw temperature tomorrow: 21 to 26 °C (not yet used by the model).

### Oddities

- Price: no saved forecast for yesterday; first score tomorrow.
- Price: TSO load forecast for 2026-07-18 not yet published (24 h persisted from the day before).
...
- Expected peak price: **178 EUR/MWh** around 20:00 local.
- P50 range: 68 – 178 EUR/MWh; band at peak 144 – 237.
